...
print("memory_usage cost {0} \nmemory_usage value {1} \nmemory_usage miliage {2}".format(result_cost.memory_usage(deep=True),
                                                                                    result_value.memory_usage(deep=True),
                                                                                    result_miliage.memory_usage(deep=True)))
